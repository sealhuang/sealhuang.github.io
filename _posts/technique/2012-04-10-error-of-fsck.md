...
`注`：以下内容转自一墙外的 [blog][http://bitc.bme.emory.edu/~lzhou/blogs/?p=70]
...
However, for a valid directory entry, it cannot be ZEROlength.  It has to have at least two entriesnamely ‘.’ linking to itself and ‘..’ linking to its parentdirectory.  However, since this directory entryhas zero length, fsck failed creating ‘..’ thus resulted theerror
“Couldn'tfix parent of inode 122068977: Couldn't find parent directoryentry"
and resulted a fail of the fsck.
[SOLUTION]
When fsck is done, mount the FS.  Then cd thelost+found/ directory:
mount #
cd #
cd lost+found
